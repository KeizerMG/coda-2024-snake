...
void renderGame(SDL_Renderer* renderer) {
    ...
    switch (snake.direction) {
        case UP: SDL_RenderCopy(renderer, headUpTexture, NULL, &headRect); break; //Début chat gpt
    ...
    for (int i = 1; i < snake.length - 1; i++) { //debut chatgpt
    ...
    switch (tailDirection) { //fin chatgpt
